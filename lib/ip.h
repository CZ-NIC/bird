...
{ ASSERT(pos < 32); return (_I(a) >> (31 - pos)) & 1; }
...
{ ASSERT(pos < 128); return (a.addr[pos / 32] >> (31 - (pos % 32))) & 0x1; }
...
{ ASSERT(pos < 32); _I(a) |= val << (31 - pos); return a; }

static inline ip6_addr ip6_setbits(ip6_addr a, uint pos, uint val)
{ ASSERT(pos < 128); a.addr[pos / 32] |= val << (31 - pos % 32); return a; }
