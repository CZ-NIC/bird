 ...
 *
 *   RTC_PREFIX_POSITION_IGNORE	  - no valid RTC format, the position is irrelevant
 *   RTC_POSITION_TYPE_ASN_IP	  - the end of prefix lies exactly between type field and ASN/IPv4 field
 *   RTC_POSITION_ASN_IP	  - the end of prefix lies inside ASN/IPv4 field
 *   RTC_POSITION_ASN_IP_VALUE	  - the end of prefix lies exactly between ASN/IPv4 field and value field
 *   RTC_POSITION_VALUE		  - the end of prefix lies inside value field
 *   RTC_POSITION_END		  - the end of prefix lies at the end of the RTC
 */
